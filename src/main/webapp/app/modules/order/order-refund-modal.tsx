...
const OrderModalRefund = (props: IOrderModalRefundProps) => {
  ...
  return (
    <Modal isOpen={props.showRefundModal} toggle={handleOrderRefundClose} backdrop="static" id="order-refund-page" autoFocus={false}>
      <Form onSubmit={handleOrderRefundSubmit}>
        ...
        <ModalBody>
          <Row>
            <Col md="12">
              <div className="container_no_margin">
